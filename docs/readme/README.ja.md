...
ライトストリップも制御できます。センサーがなくても、地域の天気、太陽高度、日の出、
日没、季節ごとの昼の長さから推奨輝度を計算できます。
...
- **Weather & sun** 用のネット接続と位置情報、または **USB sensor** 用の
  ESP32-C3 SuperMini と GY-302/BH1750 センサー
...
- 天気、太陽、季節、個人オフセットによるハードウェア不要の推奨輝度
