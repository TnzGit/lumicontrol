...
import type { LightAction, RelayContactMode, SettingsDocument, ThemeMode } from "../types";
  ...
  return (
    <div className="view settings-view">
      ...
      <Section title="Weather and solar time">
        <Toggle label="Use local weather and sunrise/sunset" checked={draft.settings.weather.enabled} onChange={(checked) => mutate((next) => { next.settings.weather.enabled = checked; })} />
        <div className="field-grid settings-grid">
